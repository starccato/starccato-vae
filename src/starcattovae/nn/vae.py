...
class VAE(nn.Module):
    def __init__(self, latent_dim, hidden_dim, input_dim, param_dim, input_channels, DEVICE):
        ...
        self.encoder = Encoder(input_dim=input_dim, hidden_dim=hidden_dim, latent_dim=latent_dim, param_dim=param_dim)
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, hidden_dim, param_dim, output_dim):
        ...
        self.FC_x_input = nn.Linear(param_dim, param_dim)
...
class Encoder(nn.Module):
    def __init__(self, input_dim, hidden_dim, latent_dim, param_dim):
        ...
        self.FC_x_input = nn.Linear(param_dim, param_dim)
        self.FC_input = nn.Linear(input_dim + param_dim, hidden_dim)
